...
public class OneTwoService {
    ...
    PersistenceAbstraction<GenericAggregateRoot001, Long> repo001;

    PersistenceAbstraction<GenericAggregateRoot002, Long> repo002;

    public void doSomethingInvolvingBothAggregates(Long aggOneRef, Long aggTwoRef, int numElement) {
